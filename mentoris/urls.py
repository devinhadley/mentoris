...
urlpatterns = [
    ...
    path("fetch_attachments/question/<int:question_id>/",
         views.fetch_attachments_question, name="fetch_attachments_question"),
    path("fetch_attachments/support/<int:support_id>/",
         views.fetch_attachments_support, name="fetch_attachment_support"),
    path("fetch_attachments_inputs/support/<int:support_id>/",
         views.fetch_attachments_inputs_support, name="fetch_attachments_inputs_support"),
    path("fetch_attachments_inputs/question/<int:question_id>/<str:part>/",
         views.fetch_attachments_inputs_question, name="fetch_attachments_inputs_question"),
    path("latex_window/question/<int:question_id>/<str:part>/<int:width>/",
         views.latex_window_question, name="latex_window_question"),
    path("latex_window/support/<int:support_id>/<int:width>/",
         views.latex_window_support, name="latex_window_support"),
    ...
    path("reset_password/<uidb64>/<token>/",
         views.verify_reset, name="verify_reset"),
    ...
    path("create_support/<int:quiz_id>",
         views.create_support, name="create_support"),
    path(
    ...
    path('delete-handle/<str:handle>/<int:site_id>/<uuid:user_id>',
         views.delete_handle, name='delete_handle'),
    path('chapter-feedback/<',
         views.create_feedback, name='create_feedback'),
